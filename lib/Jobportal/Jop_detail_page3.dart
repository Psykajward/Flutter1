...
import 'colors.dart';
import 'images.dart';
class JobDetailPage3 extends StatefulWidget {
  static Route<T> getJobDetail3<T>() {
    return MaterialPageRoute(
      builder: (_) => JobDetailPage3(),
    );
  }

  @override
  _JobDetailPage3State createState() => _JobDetailPage3State();
}

class _JobDetailPage3State extends State<JobDetailPage3> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.asset(Images.bitbucket, height: 40),
              SizedBox(
                width: 30,
              ),
              Column(
          ...
          Row(
            children: [
              ...
              _headerStatic("Applicants", "10"),
              _headerStatic("Salary", "\$1400.00"),
            ],
          ),
          SizedBox(height: 40),
          Row(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(
            "your responsible for destruction of building that needs to be removed from specific area under supervising for Engineer ",
